...
public class VoluntarioTarefaRepository implements Map<Integer, VoluntarioTarefa> {
    ...
    private static final String INSERT_VOLUNTARIO_TAREFA = "INSERT INTO voluntario_tarefa (id_voluntario, id_tarefa, descricao, nr_horas) VALUES (?,?,?,?)";
    private static final String UPDATE_VOLUNTARIO_TAREFA = "UPDATE voluntario_tarefa SET id_voluntario = ?, id_tarefa = ?, descricao = ?, nr_horas = ? where id_voluntario_tarefa = ?";

    private static final String SELECT_VOLUNTARIO_TAREFA = "SELECT id_voluntario_tarefa, voluntario.nome_voluntario, descricao, nr_horas FROM voluntario_tarefa INNER JOIN voluntario ON voluntario.id_voluntario = voluntario_tarefa.id_voluntario WHERE id_voluntario_tarefa = ?";
    private static final String SELECT_VOLUNTARIOS_TAREFAS = "SELECT id_voluntario_tarefa, voluntario.nome_voluntario, descricao, nr_horas FROM voluntario_tarefa INNER JOIN voluntario ON voluntario.id_voluntario = voluntario_tarefa.id_voluntario";
