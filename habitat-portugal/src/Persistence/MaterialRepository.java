...
public class MaterialRepository implements Map<Integer, Material> {
    ...
    private static final String INSERT_MATERIAL = "insert into material_projecto (quant_necessaria, quant_actual, motivo, projecto_id, stock_id) values (?,?,?,?,?)";
    private static final String UPDATE_MATERIAL = "update material_projecto set quant_necessaria = ?, quant_actual = ?, motivo = ?, projecto_id = ?, stock_id = ? where id_material = ?";
    ...
    private static final String SELECT_MATERIAL = "SELECT id_material,stock.descricao,quant_necessaria,quant_actual, motivo, projecto_id, stock_id FROM material_projecto INNER JOIN stock ON material_projecto.stock_id = stock.id_stock WHERE id_material = ?";
    private static final String SELECT_MATERIAIS = "SELECT id_material,stock.descricao,quant_necessaria,quant_actual, motivo, projecto_id, stock_id FROM material_projecto INNER JOIN stock ON material_projecto.stock_id = stock.id_stock";
    private static final String SELECT_BY_PROJECTO = "SELECT id_material,stock.descricao,quant_necessaria,quant_actual, motivo, projecto_id, stock_id FROM material_projecto INNER JOIN stock ON material_projecto.stock_id = stock.id_stock where projecto_id = ?";
    ...
    public Material put(Integer key, Material value) {
        ...
        try {
            ...
            statement.setInt(5, (value.getStock_id()));
